...
abstract class $RecipeCopyWith<$Res> {
  ...
  @useResult
  $Res call({String optionName, List<Ingredient> ingredients});
}
...
class _$RecipeImpl with DiagnosticableTreeMixin implements _Recipe {
  const _$RecipeImpl(
      {required this.optionName, required final List<Ingredient> ingredients})
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Recipe(optionName: $optionName, ingredients: $ingredients)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('optionName', optionName))
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, optionName,
